package com.tiantian.api.cart;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.core.JsonParseException;
import com.fasterxml.jackson.databind.JsonMappingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.tiantian.api.order.orderEntity.BuyerCart;
import com.tiantian.api.order.orderEntity.BuyerItem;
import com.tiantian.api.order.orderEntity.Sku;
...
public class CartController {
 //加入购物车
      ...
      public <T> String buyerCart(Long skuId, Integer amount, HttpServletRequest request,
         ...
         username = SessionUtils.getSystemUser();
                     if (null != username) {
                         //登录了
                         //4, 将购物车追加到Redis中
